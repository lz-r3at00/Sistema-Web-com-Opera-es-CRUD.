    ...
    db.query(sql,[id], (err,results)=>{
        ...
        <!DOCTYPE html>
            ...
            <form action="/atualizar/${results[0].id}?_method=PUT" method="POST">
                ...
                <input type="text" id="usuario" name="usuario" value="${results[0].usuario}" required>
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="${results[0].email}" required>
                <label for="telefone">Telefone:</label> 
                <input type="tel" id="telefone" name="telefone" value="${results[0].telefone}" required> <br>
